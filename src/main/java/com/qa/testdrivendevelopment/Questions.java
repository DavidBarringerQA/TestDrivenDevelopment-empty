...
public class Questions {
  ...
  /**
   * Given a string, return a string where for every char in the original string, there are three
   * chars.<br>
   * <br>
   * For Example:<br>
  ...
  public String multiChar(String input) {
    return input
        .chars()
        .mapToObj(c -> "" + (char) c + (char) c + (char) c)
        .collect(Collectors.joining(""));
  }

  /**
   * Return the string (backwards) that is between the first and last appearance of "bread" in the
   * given string, or return the empty string "" if there is not 2 occurances of "bread". Ignore
   * Case<br>
   * <br>
  ...
  public String sandwichFilling(String sandwich) {
    ...
    return new StringBuilder(
            sandwich.substring(
                sandwich.toLowerCase().indexOf("bread") + 5,
   ...
   * the difference between medium and large. Do not assume the ints will come to you in a
   * reasonable order.<br>
   * <br>
   * For Example:<br>
  ...
  /**
   * Given a string and an int n, return a string that removes n letters from the'middle' of the
   * string. The string length will be at least n. The input string will have an odd number of
   * letters. n will always be an odd number.<br>
   * <br>
   * For Example:<br>
   * nMid("Hello", 3) → "Ho"<br>
  ...
  public String nMid(String input, int n) {
    int start = (int) (Math.floor(input.length() / 2) - Math.floor(n / 2));
    return input.substring(0, start) + input.substring(start + n);
  }

  /**
   * Given a string, return the boolean True if it ends in "java" and False if does not end in
   * "java". Ignore Case.<br>
   * <br>
   * For Example: <br>
   ...
   * adjacent chars that are the same, do not ignore case.<br>
   * <br>
  ...
  /**
   * Given a string - return the number of times "am" appears in the String ignoring case - BUT ONLY
   * WHEN the word "am" appears without being followed or preceded by other letters <br>
   * <br>
   * For Example: <br>
  ...
  public int amISearch(String sentence) {
    String[] l = sentence.toLowerCase().split(" ");
    int count = 0;
    for (String s : l) {
      if (s.equals("am")) {
        count++;
  ...
  /**
   * Given a number if this number is divisible by 3 return "fizz" if this number is divisible by 5
   * return "buzz" if this number is divisible by both 3 and 5 return "fizzbuzz" if this number is
   * not divisible by 3 or 5 return null<br>
   * <br>
   * For Example: <br>
   * fizzBuzz(3) → "fizz" <br>
   * fizzBuzz(10) → "buzz" <br>
  ...
  /**
   * Given a string, split the string into the individual numbers present then add each digit of
   * each number to get a final value for each number <br>
   * <br>
  ...
  public int largest(String input) {
    ...
    for (String s : l) {
      int val = s.chars().map(i -> Character.getNumericValue((char) i)).sum();
      if (val > largest) {
        largest = val;
      }
    }
  ...
  /**
   * Given a string, int and a char, return a boolean value if the 'nth' (represented by the int
   * provided) char of the String supplied is the same as the char supplied. The int provided will
   * NOT always be less than than the length of the String. Ignore case and Whitespace. <br>
   * <br>
   * For Example: <br>
  ...
  public boolean compares(String word, int index, char letter) {
    return (index > word.length()) ? false : letter == word.charAt(index - 1);
  }
}
